#!/bin/bash
if cd "$DOS_BUILD_BASE""kernel/lge/msm8974"; then
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2016-6675/prima/0001.patch --directory=drivers/staging/prima
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2021-Misc2/ANY/0023.patch
git apply $DOS_PATCHES_LINUX_CVES/CVE-2021-Misc2/ANY/0024.patch
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2024-47740/4.4/0008.patch

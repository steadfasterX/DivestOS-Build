#!/bin/bash
if cd "$DOS_BUILD_BASE""kernel/asus/fugu"; then
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2014-0038/^3.13/0001.patch
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2016-2438/^4.4/0001.patch

#!/bin/bash
if cd "$DOS_BUILD_BASE""kernel/huawei/angler"; then
...
git apply $DOS_PATCHES_LINUX_CVES/0006-AndroidHardening-Kernel_Hardening/ANY/0003.patch

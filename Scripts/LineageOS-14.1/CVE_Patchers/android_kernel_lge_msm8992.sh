#!/bin/bash
if cd "$DOS_BUILD_BASE""kernel/lge/msm8992"; then
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2015-3288/3.10/0002.patch
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2016-5346/3.18/0002.patch
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2017-9075/3.10/0002.patch
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2017-10661/3.10/0003.patch
git apply $DOS_PATCHES_LINUX_CVES/CVE-2017-10662/3.10/0003.patch
git apply $DOS_PATCHES_LINUX_CVES/CVE-2017-10663/3.10/0003.patch
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2018-20510/4.4/0004.patch
